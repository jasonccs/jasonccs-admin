...
return [
    ...
    "password.uncompromised"=>"给定的 :attribute 出现在已经泄漏的密码中。请选择不同的 :attribute。",
    ...
    "slug_input_explanation"=>"此 slug 短标签用于在 URL 中识别您的团队。",
    ...
    "you_have_x_invitations_remaining"=>"您目前还剩 :count 个邀请额度。",
